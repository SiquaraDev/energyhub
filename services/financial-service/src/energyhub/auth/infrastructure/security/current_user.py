...
async def get_current_user(
    ...
    # Alimenta o `user_id` do `AuditEvent` sem propagar o usuário por parâmetro em todas as camadas:
    # os routers usam esta dependência apenas como guard, e os serviços leem o ator do ContextVar.
