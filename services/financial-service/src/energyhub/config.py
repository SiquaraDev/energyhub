"""Configuração do **financial-service** (Fase 15)."""
...
class Settings(BaseSettings):
    """Configurações do serviço financeiro."""
    ...
    service_host: str = "financial-service"

    # Dependências upstream (Financial → Auth, Clients, Contracts).
