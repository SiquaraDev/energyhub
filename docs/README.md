...
> 📌 **Estado:** Fases 0–4 implementadas (versão `0.4.0`); a próxima é a **Fase 5**.
...
| 🏗️ **[ARCHITECTURE.md](./ARCHITECTURE.md)** | Guia da arquitetura como-construída (Clean Architecture, classes-base, modelo de domínio e schema do banco — Fases 2–4) |
