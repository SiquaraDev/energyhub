...
> 📌 **Estado:** Fases 0–11 implementadas (versão `0.11.0`); a próxima é a **Fase 12**.
...
| 🏗️ **[ARCHITECTURE.md](./ARCHITECTURE.md)** | Guia da arquitetura como-construída (Clean Architecture, classes-base, domínio, schema do banco, persistência, API REST, segurança JWT/RBAC, documentação/erros da API, cache Redis, mensageria RabbitMQ/Kafka e busca Elasticsearch — Fases 2–11) |
