...
> 📌 **Estado:** Fases 0–5 implementadas (versão `0.5.0`); a próxima é a **Fase 6**.
...
| 🏗️ **[ARCHITECTURE.md](./ARCHITECTURE.md)** | Guia da arquitetura como-construída (Clean Architecture, classes-base, modelo de domínio, schema do banco e persistência — Fases 2–5) |
